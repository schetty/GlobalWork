//
//  EditTravelerProfileViewController.swift
//  GlobalWork
//
...
class EditTravelerProfileViewController: UIViewController, /*UICollectionViewDelegate,*/ UIImagePickerControllerDelegate, UINavigationControllerDelegate, SSRadioButtonControllerDelegate, UITextViewDelegate {
    ...
    @IBOutlet var countriesVisitingTextField: UITextField!
    ...
    @IBAction func didPressSaveChanges(_ sender: UIButton) {
        ...
        let countriesUserWillVisit = (self.countriesVisitingTextField.text ?? "")
    ...
    let placeholderText = "enter a description about yourself, your skillset, and what you can offer hosts in return for accommodating you 🙃"
